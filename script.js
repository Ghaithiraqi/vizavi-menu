...
const menuData = [
  ...
  {
    name: "Hellim Peyniri Salatası",
    category: "Soğuk Mezeler Menü",
    price: "₺265,00",
    image: "./images/hellim-salatasi.jpg",
    shortDescription: "Izgara hellim peyniri, taze yeşillikler ve zeytinyağıyla hazırlanan ferah salata.",
    ingredients: ["Hellim peyniri", "Marul", "Domates", "Salatalık", "Zeytinyağı", "Limon"],
    allergens: ["Süt içerir"],
    tags: [],
  },
  {
    name: "Kızarmış Patlıcan",
    category: "Soğuk Mezeler Menü",
    price: "₺150,00",
    image: "./images/kizarmis-patlican.jpg",
    shortDescription: "Altın renginde kızartılmış patlıcan dilimleri; sarımsaklı sos eşliğinde.",
    ingredients: ["Patlıcan", "Bitkisel yağ", "Sarımsaklı sos"],
    allergens: [],
    tags: ["🌱 Vejetaryen"],
  },
  {
  ...
  },
  {
    ...
    ingredients: ["Tavuk", "Sumaklı soğan", "İnce ekmek", "Zeytinyağı", "Baharatlar", "Tahin sos"],
    allergens: ["Gluten içerir", "Süt ürünleri içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: ["⭐ Popüler"],
  },
  {
    ...
    ingredients: ["Tavuk şavarma", "Sumaklı soğan", "İnce ekmek (saç ekmeği)", "Çıtır patates", "Turşu", "Tahin sos"],
    allergens: ["Gluten içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: ["🔥 Sıcak"],
  },
  {
  ...
  },
  {
    ...
    shortDescription: "Domates soslu, baharatlı sıcak yumurta yemeği; ekmekle servis edilir.",
    ingredients: ["Yumurta", "Domates", "Biber", "Soğan", "Baharatlar"],
    allergens: ["Yumurta içerir"],
    tags: ["🔥 Sıcak"],
  },
  {
    ...
    shortDescription: "Çıtır çıtır kızartılmış, sıcak servis edilen patates.",
    ingredients: ["Patates", "Bitkisel yağ", "Tuz"],
    allergens: [],
    tags: ["🌱 Vejetaryen"],
  },
  {
    ...
    shortDescription: "Bol kaşar peyniriyle hazırlanan, dışı çıtır içi eriyen sıcacık tost.",
    ingredients: ["Tost ekmeği", "Kaşar peyniri", "Tereyağı"],
    allergens: ["Gluten içerir", "Süt içerir"],
    tags: ["🔥 Sıcak"],
  },
  {
    name: "Patates Sandviçi",
    category: "Ana Yemekler",
    price: "₺120,00",
    image: "./images/patates-sandvici.jpg",
    shortDescription: "Çıtır patates, turşu ve özel soslarla hazırlanan doyurucu sandviç.",
    ingredients: ["Patates kızartması", "Ekmek", "Turşu", "Özel sos"],
  ...
  },
  {
    ...
    category: "Ana Yemekler",
    price: "₺350,00",
    image: "./images/et-burger.jpg",
    shortDescription: "Izgara dana köftesi, taze malzemeler ve özel soslarla hazırlanan doyurucu burger; patates eşliğinde.",
    ingredients: ["Dana köfte", "Burger ekmeği", "Marul", "Domates", "Turşu", "Özel sos", "Patates"],
    allergens: ["Gluten içerir"],
    tags: ["🔥 Sıcak"],
  },
  {
  ...
  },
  {
    ...
    ingredients: ["Humus", "Falafel", "Tahin sos", "Taze sebzeler"],
  ...
  },
  {
    ...
    ingredients: ["Çıtır falafel", "Hummus", "Çıtır patates", "Taze sebzeler", "Turşu", "2 ekmek"],
    allergens: ["Gluten içerir", "Susam içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: ["⭐ Popüler"],
  },
  {
    ...
    ingredients: ["Falafel (10 adet)", "Tahin sos", "2 ekmek"],
    allergens: ["Susam içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: ["🌱 Vejetaryen"],
  },
  {
    ...
    ingredients: ["Izgara falafel", "Taze sebzeler", "Turşu", "Kırmızı lahana", "Tahin sos", "İnce ekmek"],
    allergens: ["Gluten içerir", "Susam içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: ["Diyet"],
  },
  {
  ...
  },
  {
    ...
    ingredients: ["Çıtır falafel", "Burger ekmeği", "Marul", "Domates", "Turşu", "Tahin sos"],
    allergens: ["Gluten içerir", "Susam içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: [],
  },
  {
    name: "Falafel Salatası",
    category: "Falafel Menü",
    price: "₺250,00",
    image: "./images/falafel-salatasi.jpg",
    shortDescription: "Çıtır falafel parçaları, taze yeşillikler ve tahin soslu ferah salata.",
    ingredients: ["Falafel (6 adet)", "Marul", "Domates", "Salatalık", "Maydanoz", "Taze nane", "Tahin sos"],
  ...
  },
  {
    ...
    category: "Falafel Menü",
    price: "₺170,00",
    image: "./images/falafel-durum.jpg",
    shortDescription: "Çıtır falafel, taze sebzeler ve tahin soslu, ince lavaşta sarılmış pratik dürüm.",
    ingredients: ["Falafel", "Marul", "Domates", "Turşu", "Tahin sos", "Lavaş"],
    allergens: ["Gluten içerir", "Susam içerir"],
    tags: ["🌱 Vejetaryen"],
  },
  {
    name: "Süper Falafel Dürüm",
    category: "Falafel Menü",
    price: "₺230,00",
    image: "./images/super-falafel-durum.jpg",
    shortDescription: "Bol falafel, zengin malzeme ve özel soslarla hazırlanan doyurucu büyük dürüm.",
    ingredients: ["Bol falafel", "Marul", "Domates", "Turşu", "Patates", "Tahin sos", "Lavaş"],
    allergens: ["Gluten içerir", "Susam içerir"],
    tags: ["🌱 Vejetaryen"],
  },
  {
    ...
    ingredients: ["Hummus", "Kavrulmuş bademler", "Taze ekmek parçaları", "Arap sadeyağı", "Özel soslar"],
  ...
  },
  {
    ...
    ingredients: ["Kaymak", "Özel krema", "Şurup", "Antep fıstığı"],
    allergens: ["Gluten içerir", "Süt ürünleri içerir", "Kuruyemiş içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: [],
  },
  {
  ...
  },
  {
    ...
    ingredients: ["İnce Nablus kadayıfı (yumuşak hamur)", "Künefelik peynir", "Şurup", "Antep fıstığı"],
    allergens: ["Gluten içerir", "Süt ürünleri içerir", "Kuruyemiş içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: ["⭐ Popüler"],
  },
  {
  ...
  },
  {
    ...
    price: "—",
    sizes: [
      { label: "Küçük", price: "₺35,00" },
      { label: "Büyük", price: "₺45,00" },
    ],
    image: "./images/ayran.jpg",
    shortDescription: "Taze yoğurttan hazırlanan, ferahlatıcı geleneksel Türk içeceği.",
  ...
  },
  {
    ...
    category: "İçecek Menü",
    price: "₺150,00",
    image: "./images/taze-portakal-suyu.jpg",
    shortDescription: "Günlük sıkılmış taze portakallardan hazırlanan doğal meyve suyu.",
  ...
  },
  {
    ...
    category: "İçecek Menü",
    price: "₺100,00",
    image: "./images/taze-limonata.jpg",
    shortDescription: "Taze limon, su ve naneyle hazırlanan ferahlatıcı ev yapımı limonata.",
  ...
  },
  {
    ...
    shortDescription: "Geleneksel yöntemle pişirilen, köpüklü ve yoğun aromalı Türk kahvesi.",
