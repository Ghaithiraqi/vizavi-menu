...
const menuData = [
  ...
  {
    name: "Falafel (16 Adet)",
    category: "Falafel Menü",
    price: "—",
    image: "./images/falafel-16-adet.jpg",
    shortDescription: "Nohut ve özel baharatlarla hazırlanan, dışı çıtır 16 adetlik falafel porsiyonu.",
    ingredients: ["Falafel (16 adet)", "Nohut", "Özel baharatlar", "Susam"],
    allergens: ["Susam içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: ["🌱 Vejetaryen"],
  },
  {
    ...
    shortDescription: "Çıtır falafel, taze sebzeler ve özel sosla ince ekmeğe sarılan doyurucu dürüm.",
    ingredients: ["Çıtır falafel", "Taze sebzeler", "Turşu", "Özel sos", "İnce ekmek"],
    allergens: ["Gluten içerir", "Susam içerir", "Alerjen bilgisi için lütfen personele danışınız"],
    tags: ["🌱 Vejetaryen"],
  },
  {
    ...
    shortDescription: "Bol falafel, patlıcan, çıtır patates ve özel soslarla zenginleştirilmiş doyurucu süper dürüm.",
